...
def main(args):
    ...
    for i in range(0,len(train_loaders)):
        ...
        for times in range(args.repeat):
            ...
            elif args.model_name == 'NN_TRANSF':
...
def parse_args():
    ...
    # model
    parser.add_argument('--model_name', default='TRANSFORMER')  # TRANSFORMER  NN_TRANSF
    ...
    parser.add_argument('--outdir', default='./output/all360_transf_label')

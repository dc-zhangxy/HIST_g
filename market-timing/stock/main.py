...
def loss_fn(pred, label, args):
    ...
    #                         ) # mse(pred[mask], label[mask]) # mse(pred, label) #
...
def parse_args():
    ...
    parser.add_argument('--filepath', type=str, default='data/ohlcav2424.feather')
    ...
    parser.add_argument('--outdir', default='./output/all_transf2424_label1_sche_mse1e-4')

...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        # a = F.relu(self.l2(a))
        mu = self.l2(a) # torch.tanh(self.l2(a))
        log_std = self.l3(a) #torch.tanh(self.l3(a))
...
class SAC:
    ...
    def calc_target(self, rewards, next_states, dones):
        ...
        a, log_pi_a  = self.actor(next_states)
    ...
    def update(self, transition_dict):
        ...
        mu, log_std = self.actor(states)  # 预测当前时刻的state_value  [b,n_actions]

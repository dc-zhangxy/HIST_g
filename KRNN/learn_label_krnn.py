...
from qlib.contrib.model.pytorch_krnn import KRNNModel
from pytorch_krnn import KRNNModel
...
def parse_args():
    ...
    # model
    parser.add_argument('--model_name', default='KRNN')
